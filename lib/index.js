var compilers, copyCompilerSpecificExampleFiles, create, createWithDefaults, devDependencies, exec, fs, isSystemPath, logger, makeChosenCompilerChanges, makeServerChanges, modifyBowerJSONName, moveDirectoryContents, moveViews, newProject, outConfig, packageJson, path, printHelp, program, projectName, prompting, register, runNPMInstall, servers, setupData, setupPackageJSON, skeletonOutPath, updateConfigForChosenCompilers, usingDefaultServer, usingNoServer, usingOwnServer, views, windowsDrive, wrench, writeConfigs, _;
...
register = function(_program, _logger, noop) {
  program = _program;
  logger = _logger;
...
exports.registerCommand = register;
