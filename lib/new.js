...
makeServerChanges = function(chosen) {
  ...
  if (chosen.javascript.library) {
    ...
    return outConfig.server.transpiler = "TRANSPILER" + chosen.javascript.library;
  }
};
